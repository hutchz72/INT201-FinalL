...
const SubmittedChange = document.getElementById('color-btn')

SubmittedChange.addEventListener('click', () => {
  const Changecolor = document.getElementById('rainbow')
...
changeColorBtn.addEventListener('click', (e) => {
  ...
  rainbow.style.backgroundColor =
    colorArray[Math.floor(Math.random(e) * colorArray.length)]
})
*/
