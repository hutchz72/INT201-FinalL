...
newLiEle.innerHTML = '<span style="color:red">Siam Yamsangsung</span>' //จะเรนเดอร์text ด้วย html
//newLiEle.innerHTML = '<span style="color:red">Siam Yamsangsung</span>' เห็นเป็นแค่คำเฉยๆ

//4 add new li element to a parent node
const divParent = document.querySelector('div.lecturers>ul')
console.log(divParent)
divParent.appendChild(newLiEle) //เป็นลูกที่ต่อท้ายลำดับลูกสุดท้าย เป็น nextchild
