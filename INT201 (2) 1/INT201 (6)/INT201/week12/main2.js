...
//cannot use array function (forEach, filter, map,...))
...
//NodeList data type - array-like (can use index, length) but NodeList implements
//only forEach but can not use other array functions
