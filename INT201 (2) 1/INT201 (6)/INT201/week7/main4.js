class Person {
  ...
  // compares this firstName and lastName to the specified another person object.
  //Returns false if the fullName are different and true, if it is the same (case insensitive)
